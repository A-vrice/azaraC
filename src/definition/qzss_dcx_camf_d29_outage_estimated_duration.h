...
inline constexpr std::optional<std::string_view> QZSS_DCX_CAMF_D29_OUTAGE_ESTIMATED_DURATION_TABLE[] = {
    ...
    std::string_view{"30 min ≤ duration < 45 min", 26},
    std::string_view{"45 min ≤ duration < 1 h", 23},
    std::string_view{"1 h ≤ duration < 1 h 30 min", 27},
    std::string_view{"1 h 30 min ≤ duration < 2 h", 27},
    std::string_view{"2 h ≤ duration < 3 h", 20},
    std::string_view{"3 h ≤ duration < 4 h", 20},
    std::string_view{"4 h ≤ duration < 5 h", 20},
    std::string_view{"5 h ≤ duration < 10 h", 21},
    std::string_view{"10 h ≤ duration < 24 h", 22},
    std::string_view{"24 h ≤ duration < 2 days", 24},
    std::string_view{"2 days ≤ duration < 7 days", 26},
    std::string_view{"7 days ≤ duration", 17}
};
